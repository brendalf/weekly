  ...
  return (
    <main className="relative min-h-screen bg-background overflow-hidden">
      <div
        ...
        style={{ background: "radial-gradient(ellipse, oklch(0.627 0.265 303.9 / 0.4) 0%, transparent 70%)" }}
      />

      <div className="relative mx-auto grid min-h-screen max-w-6xl grid-cols-1 gap-10 px-6 py-12 md:grid-cols-2 md:items-center">
        <section>
          <div className="inline-flex items-center gap-2 rounded-full border border-primary/30 bg-primary/5 px-3 py-1 text-xs font-medium text-primary">
            ...
            <img src="/weekly.png" alt="Weekly" width={14} height={14} className="rounded" />
          ...
          <p className="mt-5 max-w-md text-base leading-relaxed text-foreground/60">
            Plan your week, build streaks, and keep tasks moving — all in one clean interface.
          </p>
